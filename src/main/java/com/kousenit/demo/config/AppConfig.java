...
public class AppConfig {
    ...
    private ProductRequest createProduct(
            String name, BigDecimal price, String description, Integer quantity, String sku, String contactEmail) {
        return new ProductRequest(name, price, description, quantity, sku, contactEmail);
    }
}
